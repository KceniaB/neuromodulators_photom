...
# @Edited: Kcenia Bougrova 
# @Update: 2023-05-12 HCW fixed time to get rew from stim onset 
import logging
...
for i in range(sph.NTRIALS):  # Main loop
    ...
    if i == 0:  # First trial exception start camera
        ...
        sma.add_state(
            ...
            output_actions=[("Serial1", bonsai_hide_stim), ("SoftCode", 3)], #BNC1, 255 removed 
        )  # sart camera
    else:
        sma.add_state(
            state_name="trial_start",
            ...
            output_actions=[("Serial1", bonsai_hide_stim)], #BNC1, 255 removed 
        )
